...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2015 at 08:06 AM
...
--
ALTER TABLE `daftar`
 ADD PRIMARY KEY (`ID_DAFTAR`), ADD KEY `FK_DAFTAR_MEMILIKI_ERROR` (`ID_ERROR`), ADD KEY `FK_DAFTAR_MEMPUNYAI_TAGGING` (`ID_TAG`), ADD KEY `FK_DAFTAR_OE_ODP` (`ID_ODP`), ADD KEY `FK_DAFTAR_RELATIONS_KLUSTER` (`ID_KLUSTER`);
...
ADD CONSTRAINT `FK_DAFTAR_RELATIONS_KLUSTER` FOREIGN KEY (`ID_KLUSTER`) REFERENCES `kluster` (`ID_KLUSTER`);
