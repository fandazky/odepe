          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Report Cluster <?php echo $nama_kluster->nama_kluster;?> </li>
          </ol>
          ...
          <div class="row">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h1 class="box-title">
                  Chart Cluster 
                          <?php echo $nama_kluster->nama_kluster;?>
                  </h1>
                  <br>
              ...
              <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_error,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada kluster <?php echo $nama_kluster->nama_kluster;?>
                  </span>
            ...
            <div class="col-sm-6">              
              <div class="info-box bg-aqua">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_survey,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada kluster <?php echo $nama_kluster->nama_kluster;?> 
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div>
