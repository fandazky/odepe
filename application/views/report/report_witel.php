          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Report Witel Jatim Selatan </li>
          </ol>
              ...
              <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_error,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada Witel Jatim Selatan
                  </span>
            ...
            <div class="col-sm-6">              
              <div class="info-box bg-aqua">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_survey,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada Witel Jatim Selatan
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div>
