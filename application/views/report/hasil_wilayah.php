          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Report Site Operation <?php echo $namaso->nama_so;?> </li>
          </ol>
          </div>
        </section>
              ...
              <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_error,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada site operation <?php echo $namaso->nama_so;?> 
                  </span>
            ...
            <div class="col-sm-5">              
              <div class="info-box bg-aqua">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    <?php echo $ps=number_format($persen_survey,2);$ps;echo "%";?> dari <?php echo $jumlah_odp?> ODP pada site operation <?php echo $namaso->nama_so;?> 
                  </span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div>
